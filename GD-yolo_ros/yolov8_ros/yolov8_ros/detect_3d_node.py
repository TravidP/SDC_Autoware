...
class Detect3DNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self._spesific_pub = self.create_publisher(DetectionHeader, "spesific_detections_3d", 10)
    ...
    def process_detections(
        ...
        for detection in detections_msg.detections:
            ...
            detection_with_header = DetectionHeader()
            if (detection.class_id == 80 or detection.class_id == 9):
                detection_with_header.header = detections_msg.header
                detection_with_header.detection = detection
                self._spesific_pub.publish(detection_with_header)
    ...
    def convert_bb_to_3d(
        ...
        if math.isinf(bb_center_z_coord):
            return None
